...
st.markdown(f'<h1 style="color:#8d1b92;text-align: center;font-size:36px;">{"Exercises for Diabetes Patients with Posture Correction"}</h1>', unsafe_allow_html=True)
